Nick Taschyan: 
I implemented the ClientThread.java class along with the ListeningThread.java and worked a bit on the chat.java sections of the program along with figuring out how to create the makefile to easier compile it all through the terminal.  


Arya Mehrian:
For our Project 1, my partner and I created a Java program for a chat application. We have four java files and a makefile. We tested the program by connecting to other machines on our network. I also created the ServerThread.java and we worked on the chat.java together.
...
And there you go, chat app should be running successfully. 